  ...
  head: () => ({
    meta: [
      ...
      { title: "Asaí Bar — Smoothie bowls e paninis | Asa Norte, Brasília" },
      {
        name: "description",
        content:
          "Asaí Bar: smoothie bowls e paninis na CLN 202, Asa Norte, Brasília - DF. Sabor fresco, prático e do jeito que você gosta.",
      },
      { property: "og:site_name", content: "Asaí Bar" },
